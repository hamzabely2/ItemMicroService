    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FullImage = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    SideImage = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdressUsers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AdressUsers_Adresses_AdressId",
                        column: x => x.AdressId,
                        principalTable: "Adresses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AdressUsers_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ImagesItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ImagesItems_Images_ImageId",
                        column: x => x.ImageId,
                        principalTable: "Images",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ImagesItems_Items_ItemId",
                        column: x => x.ItemId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderItems_Items_IdItemNavigationId",
                        column: x => x.IdItemNavigationId,
                        principalTable: "Items",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderItems_Orders_IdOrderNavigationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdressUsers_AdressId",
                table: "AdressUsers",
                column: "AdressId");

            migrationBuilder.CreateIndex(
                name: "IX_AdressUsers_UserId",
                table: "AdressUsers",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ImagesItems_ImageId",
                table: "ImagesItems",
                column: "ImageId");

            migrationBuilder.CreateIndex(
                name: "IX_ImagesItems_ItemId",
                table: "ImagesItems",
                column: "ItemId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderItems_IdItemNavigationId",
                table: "OrderItems",
                column: "IdItemNavigationId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderItems_IdOrderNavigationId",
                table: "OrderItems",
