...
{
    [DbContext(typeof(ItemMicroServiceDbContext))]
    partial class ItemMicroServiceDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entity.Model.Basket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entity.Model.BasketItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entity.Model.BasketItem", b =>
                {
                    b.HasOne("Entity.Model.Basket", null)
            ...
            modelBuilder.Entity("Entity.Model.OrderItem", b =>
                {
                    b.HasOne("Entity.Model.Item", "IdItemNavigation")
                        .WithMany()
                        .HasForeignKey("IdItemNavigationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Entity.Model.Order", "IdOrderNavigation")
                        .WithMany("OrderItems")
